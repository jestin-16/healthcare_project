...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-w@l9^^s-d=51cur1g)kr&bt@^joah1gutm(l&+q3lqz6(ix5-i')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True').lower() == 'true'

ALLOWED_HOSTS = [
    'healthcare.jestin16.dev',
    'healthcare-project-9d6b.onrender.com',
    '.onrender.com',
    'localhost',
    '127.0.0.1',
]
...
CSRF_TRUSTED_ORIGINS = [
    'https://healthcare.jestin16.dev',
    'https://healthcare-project-9d6b.onrender.com',
    'https://*.onrender.com',
]
